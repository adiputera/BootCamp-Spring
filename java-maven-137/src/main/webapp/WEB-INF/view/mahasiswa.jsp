...
<script>
	jQuery(document).ready(function() {
		...
		//begin fungsi delete
		$('#data-emp').on('click', '.tbldelete', function(){
			var id = $(this).attr('id');
			$('#del-id').val(id); 
			$('#modal-del').modal();
		});
...
<body>
			...
			<c:forEach items="${mhss }" var="emp">
				<tr>
					...
					<td><a href="#" id="${emp.id }"
						...
						id="${emp.id }" class="update btn btn-success">Update</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="edit-mhs">
						...
						<div class="form-group">
							<label for="exampleInputPassword1">Jurusan</label> <select
								id="piljur" class="custom-select custom-select-md">
	...
	<div id="form-insert" class="modal" tabindex="-1" role="dialog">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Modal title</h5>
				...
				<div class="modal-body">
					<form:form action="${pageContext.request.contextPath }/mhs/save"
						method="post" commandName="mahasiswa">
						<form:errors path="*" cssClass="errorblock" element="div" />
						<div class="form-group">
							<label>Nama </label>
							<form:input type="text" path="name" class="form-control" data-parsley-required="true" />
						</div>
						<div class="form-group">
							<label>Jurusan </label>
						...
						<form:button class="btn btn-info" id="simpantbl">Simpan</form:button>
					</form:form>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary"
